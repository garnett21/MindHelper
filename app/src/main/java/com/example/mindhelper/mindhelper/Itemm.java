...
public class Itemm implements java.io.Serializable {
    ...
    public Itemm(long id, long datetime, Colors color, String title,
                String content,String mood,String hold, String fileName, String recFileName,
