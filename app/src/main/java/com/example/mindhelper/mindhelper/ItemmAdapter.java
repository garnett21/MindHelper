...
public class ItemmAdapter extends ArrayAdapter<Itemm> {
    ...
    public ItemmAdapter(Context context, int resource, List<Itemm> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 讀取目前位置的記事物件
        final Itemm item = getItem(position);
    ...
    // 設定指定編號的記事資料
    public void set(int index, Itemm item) {
