 ...
 */
public class TcrRequestQ67 extends StringRequest {
    private static final String Person_REQUEST_URL = "http://220.133.75.9/connection/tcrq67.php";
    private Map<String, String> params;


    public TcrRequestQ67(String ans1_when, String ans1_who, String ans1_where, String ans1_what, String ans2_emo, String ans2_per, String ans3, String ans4, String ans5, String ans6, String ans7, String note, Response.Listener<String> listener) {
