...
public class ItemmAppWidgetConfigureActivity extends Activity {
    ...
    private ItemmAdapter itemAdapter;
    private List<Itemm> items;
    private ItemDAOO itemDAOO;

    public ItemmAppWidgetConfigureActivity() {
        super();
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        itemDAOO = new ItemDAOO(getApplicationContext());
        items = itemDAOO.getAll();
        itemAdapter = new ItemmAdapter(this, R.layout.single_item, items);
    ...
    AdapterView.OnItemClickListener itemListener =
            new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    final Context context = ItemmAppWidgetConfigureActivity.this;

                    // 讀取與儲存選擇的記事物件
                    Itemm item = itemAdapter.getItem(position);
                    saveItemPref(context, mAppWidgetId, item.getId());

                    AppWidgetManager appWidgetManager =
                            AppWidgetManager.getInstance(context);
                    ItemmAppWidget.updateAppWidget(
