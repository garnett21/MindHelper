...
public class PersonRequest extends StringRequest {
    ...
    public PersonRequest(String name, String username, String password, String age,int id,String doctor,String sex,String email,String address,   Response.Listener<String> listener) {
